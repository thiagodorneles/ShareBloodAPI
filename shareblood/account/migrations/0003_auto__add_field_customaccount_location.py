...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomAccount.location'
        db.add_column(u'account_customaccount', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['location.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomAccount.location'
        db.delete_column(u'account_customaccount', 'location_id')
    ...
    models = {
        ...
        u'location.location': {
            ...
            'neighborhood': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cities_light.Region']", 'null': 'True'}),
            'street': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'zipcode': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'})
        }
    }
