...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.numbers'
        db.delete_column(u'location_location', 'numbers')

        # Adding field 'Location.number'
        db.add_column(u'location_location', 'number',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Location.numbers'
        db.add_column(u'location_location', 'numbers',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Location.number'
        db.delete_column(u'location_location', 'number')
