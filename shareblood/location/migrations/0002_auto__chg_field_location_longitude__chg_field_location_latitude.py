...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'location_location', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))

        # Changing field 'Location.latitude'
        db.alter_column(u'location_location', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))

    def backwards(self, orm):

        # Changing field 'Location.longitude'
        db.alter_column(u'location_location', 'longitude', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Location.latitude'
        db.alter_column(u'location_location', 'latitude', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    models = {
        ...
        u'location.location': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '8'}),
            'longitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '8'}),
