...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'location_location', (
            ...
            ('neighborhood', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('latitude', self.gf('django.db.models.fields.BigIntegerField')()),
            ('longitude', self.gf('django.db.models.fields.BigIntegerField')()),
        ))
