...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'donation_donation', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='owner_donation', to=orm['account.CustomAccount']),
                      keep_default=False)

        # Adding field 'Donation.blood_bank'
        db.add_column(u'donation_donation', 'blood_bank',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='blood_bank_donation', to=orm['account.CustomAccount']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.owner'
        db.delete_column(u'donation_donation', 'owner_id')

        # Deleting field 'Donation.blood_bank'
        db.delete_column(u'donation_donation', 'blood_bank_id')
