...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FavoriteBloodTypes', fields ['blood_type', 'donation']
        db.create_unique(u'donation_favoritebloodtypes', ['blood_type', 'donation_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FavoriteBloodTypes', fields ['blood_type', 'donation']
        db.delete_unique(u'donation_favoritebloodtypes', ['blood_type', 'donation_id'])
    ...
    models = {
        ...
        u'donation.favoritebloodtypes': {
            'Meta': {'unique_together': "(('blood_type', 'donation'),)", 'object_name': 'FavoriteBloodTypes'},
            'blood_type': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
