...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DonationHistory.date'
        db.delete_column(u'donation_donationhistory', 'date')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DonationHistory.date'
        db.add_column(u'donation_donationhistory', 'date',
